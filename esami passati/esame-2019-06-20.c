...
int prof_nodi (nodo_albero* a, int prof) {
	if(a==NULL)
		return 0;
	if(prof==0)
		return 1;
	return prof_nodi(a->left,prof-1) + prof_nodi(a->right,prof-1);
}
