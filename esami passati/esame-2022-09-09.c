#include <stdio.h>
#include <stdlib.h>
/*esame 09-09-2022 variante*/			//corretto
/*  verifica se in quell'altezza quante foglie ci sono e confrontalo con il sottografo piu grande*/
...
int prof_foglie (nodo_albero* a, int alt) {
	if(a==NULL)
		return 0;
	if(alt==0 && (a->left==NULL && a->right==NULL)) 
		return 1;
	return prof_foglie(a->left,alt-1) + prof_foglie(a->right,alt-1);
}
